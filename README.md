...
1. **Hit the GIPHY API**.
   ...
   * Be sure to read about these GIPHY parameters (hint, hint):
     ...
     * `limit`
     * `rating`
   * Like many APIs, GIPHY requires developers to use a key to access their API data. To use the GIPHY API, you'll need a GIPHY account (don't worry, it's free!) and then obtain an API Key: FdmuOJSslqKU6gLafd20LU84NCHTjp9W(https://developers.giphy.com/dashboard/?create=true).
